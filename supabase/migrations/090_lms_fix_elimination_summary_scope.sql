-- =============================================================================
-- LMS: fix elimination summary competition scoping
-- =============================================================================
-- Bug: league-scoped counts used `p.competition_id = c.id` after joining
-- competitions on that same id (always true), so eliminations from OTHER
-- leagues in the season were included. Use `p.competition_id = p_competition_id`.
-- =============================================================================
...
comment on function public.lms_get_elimination_summary(text, uuid) is
  'Per completed GW: eliminated_count, entrants_count, survival_pct. Overall = caller''s leagues; league = that competition only.';
