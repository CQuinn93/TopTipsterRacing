// Third-place combination matrix - Full 495 combinations
// Parsed from FIFA World Cup 2026 Round of 32 schedule matrix
// Format: "ROW_NUM GROUP1 GROUP2 ... GROUP8 3ASSIGN1 3ASSIGN2 ... 3ASSIGN8"

/**
 * All 495 combinations as simple strings
 * Format: "ROW_NUM GROUP1 GROUP2 GROUP3 GROUP4 GROUP5 GROUP6 GROUP7 GROUP8 3ASSIGN1 3ASSIGN2 3ASSIGN3 3ASSIGN4 3ASSIGN5 3ASSIGN6 3ASSIGN7 3ASSIGN8"
 * 
 * Example: "7 D E F G H I K L 3E 3G 3I 3D 3H 3F 3L 3K"
 * This means: Row 7, advancing groups D E F G H I K L, match assignments are 3E 3G 3I 3D 3H 3F 3L 3K
 * 
 * Match assignments correspond to matches in this order:
 * 1A vs (Match 79), 1B vs (Match 85), 1D vs (Match 81), 1E vs (Match 74), 
 * 1G vs (Match 82), 1I vs (Match 77), 1K vs (Match 87), 1L vs (Match 80)
 */
export const COMBINATIONS: string[] = [
  ...
  // TODO: Add remaining 460 combinations from the Wikipedia table
  // The full matrix has 495 combinations total
];
